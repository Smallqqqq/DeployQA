...
class Tokenizer:
    ...
    def load(cls, pretrained_model_name_or_path, revision=None, tokenizer_class=None, use_fast=True, **kwargs):
        ...
        if "AlbertTokenizer" in tokenizer_class:
            ...
            if use_fast:
                '''if "mlnm" in pretrained_model_name_or_path: 
                        ret =ByteLevelBPETokenizer("/mnt/sda/haystack/haystack/saved_vocab/testspacy_v1.0_1572-11400token/vocab.json","/mnt/sda/haystack/haystack/saved_vocab/testspacy_v1.0_1572-11400token/merges.txt")
                else: '''
